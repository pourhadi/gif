...
var _accentHue: Binding<CGFloat> = Binding<CGFloat>(get: { () -> CGFloat in
    ...
    _accentColorBinding.wrappedValue = UIColor(hue: newValue, saturation: _accentSaturation.wrappedValue, brightness: 1.0, alpha: 1.00)
...
var _accentSaturation: Binding<CGFloat> = Binding<CGFloat>(get: { () -> CGFloat in
    ...
    _accentColorBinding.wrappedValue = UIColor(hue: _accentHue.wrappedValue, saturation: newValue, brightness: 1.0, alpha: 1.00)
...
extension Color {
    ...
    static var accent: Color { Color(_accent) }
